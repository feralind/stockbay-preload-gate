...
function mediaHtml(media, className = 'estate-media-img') {
  return `
    <!-- IMAGE PLACEHOLDER: ${escapeHtml(media.imageAlt)}
         Future path: ${escapeHtml(media.imageFuturePath)}
         Replace later with hyper-realistic image generated by Grok -->
    <img class="${escapeAttr(className)}" src="${escapeAttr(media.imagePlaceholder)}" alt="${escapeAttr(media.imageAlt)}" loading="lazy" decoding="async">
  `;
}
